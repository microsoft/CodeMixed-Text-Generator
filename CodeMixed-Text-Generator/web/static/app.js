$(document).ready(function() {
    ...
    var disc = "Parse Tree Visualisation in Matrix Language theory is being enhanced and it will be available soon.";
    ...
    $(".form-check").on("click", function(event){
        ...
        if (val == "ec"){
            ...
            $("#treeVizDiv").html("Click on a sentence to see it's parse tree here.");
        }else{
            $("#theory-card").html(ml_theory);
            $("#treeVizDiv").html(disc);
        }
    });
