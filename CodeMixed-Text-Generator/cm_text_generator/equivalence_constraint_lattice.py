    ...
    while nextEP < len(node.children):
        ...
        if nextEP - prevEP == 1:
            ...
            for index in range(prevEP, nextEP):
                engDfa.mergeDfaSeries(node.children[index].doof, linguistic_theory)
                hinDfa.mergeDfaSeries(
                    node.counterpart.children[index].counterpart.doof, linguistic_theory)
            engDfa.mergeDfaParallel(hinDfa, linguistic_theory)

        d.mergeDfaSeries(engDfa, linguistic_theory)
...
def insertSensiblyEng(bigDfa, smallDfa):
    ...
    if bigDfa.engEnd == -1 and bigDfa.mixEnd == -1 and bigDfa.hinEnd == -1:
        bigDfa.mergeDfa(smallDfa, linguistic_theory)
        ...
        if bigDfa.hinEnd == -1:
            if smallDfa.mixEnd == -1:
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.mergeDfa(smallDfa, linguistic_theory)
                    bigDfa.mergeStates(bigDfa.engEnd, [nextStart], linguistic_theory)
                ...
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.engEnd = smallDfa.engEnd + nextStart
                    bigDfa.mergeStates(
                        smallDfa.mixEnd + nextStart, [smallDfa.hinEnd + nextStart], linguistic_theory)
                    bigDfa.mixEnd = smallDfa.mixEnd + nextStart
                    bigDfa.hinEnd = -1
        else:
            if smallDfa.mixEnd == -1:
                if smallDfa.hinEnd == -1:
                    ...
                    nextStart = bigDfa.nextIndex
                    bigDfa.mergeDfa(smallDfa, linguistic_theory)
                    bigDfa.mergeStates(bigDfa.hinEnd, [nextStart], linguistic_theory)
                    ...
                    bigDfa.mergeStates(hangerOne, [hangerTwo], linguistic_theory)
                ...
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.hinEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.engEnd + nextStart, [smallDfa.mixEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.engEnd + nextStart
                    ...
                    bigDfa.hinEnd = smallDfa.hinEnd + nextStart
                    bigDfa.mergeStates(
                        smallDfa.mixEnd + nextStart, [smallDfa.engEnd + nextStart], linguistic_theory)
        ...
        if bigDfa.hinEnd == -1:
            if smallDfa.mixEnd == -1:
                if smallDfa.hinEnd == -1:
                    ...
                    nextStart = bigDfa.nextIndex
                    bigDfa.mergeDfa(smallDfa, linguistic_theory)
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mixEnd = smallDfa.engEnd + nextStart
                else:
                    # 6
                    nextStart = bigDfa.nextIndex
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.engEnd + nextStart, [smallDfa.hinEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.engEnd + nextStart
                ...
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.engEnd + nextStart, [smallDfa.mixEnd + nextStart, smallDfa.hinEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.engEnd + nextStart
            ...
            if smallDfa.mixEnd == -1:
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [bigDfa.hinEnd], linguistic_theory)
                    nextStart = bigDfa.nextIndex
                    bigDfa.mergeDfa(smallDfa, linguistic_theory)
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mixEnd = smallDfa.engEnd + nextStart
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.engEnd + nextStart, [smallDfa.hinEnd + nextStart, smallDfa.hinEnd], linguistic_theory)

                    bigDfa.mergeStates(smallDfa.engEnd +
                                       nextStart, [hangerOne, hangerTwo], linguistic_theory)
                ...
                if smallDfa.hinEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.mixEnd + nextStart, [smallDfa.engEnd + nextStart, smallDfa.hinENd + nextStart], linguistic_theory)
        ...
        if bigDfa.engEnd == -1:
            ...
            if smallDfa.mixEnd == -1:
                ...
                if smallDfa.engEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.engEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.hinEnd + nextStart, [smallDfa.mixEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.hinEnd + nextStart
        ...
        if bigDfa.engEnd == -1:
            if smallDfa.mixEnd == -1:
                if smallDfa.engEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.hinEnd + nextStart, [smallDfa.engEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.hinEnd + nextStart
                ...
                if smallDfa.engEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.hinEnd + nextStart, [smallDfa.mixEnd + nextStart, smallDfa.engEnd + nextStart], linguistic_theory)
                    hangerTwo = smallDfa.hinEnd + nextStart
            ...
            if smallDfa.mixEnd == -1:
                if smallDfa.engEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [bigDfa.engEnd], linguistic_theory)
                    nextStart = bigDfa.nextIndex
                    bigDfa.mergeDfa(smallDfa, linguistic_theory)
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mixEnd = smallDfa.hinEnd + nextStart
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.hinEnd + nextStart, [smallDfa.engEnd + nextStart, smallDfa.engEnd], linguistic_theory)
                ...
                if smallDfa.engEnd == -1:
                    ...
                    bigDfa.mergeStates(bigDfa.mixEnd, [nextStart], linguistic_theory)
                    bigDfa.mergeStates(
                        smallDfa.mixEnd + nextStart, [smallDfa.hinEnd + nextStart, smallDfa.engENd + nextStart], linguistic_theory)
...
def attachFinal(doof, engDfa):
    ...
    if doof.mixEnd == -1 and doof.engEnd == -1 and doof.hinEnd == -1:
        doof.mergeDfa(engDfa, linguistic_theory)
        ...
        if doof.mixEnd == -1:
            if engDfa.mixEnd == -1:
                ...
                doof.mergeDfa(engDfa, linguistic_theory)
                doof.mergeStates(doof.engEnd, [nextStart], linguistic_theory)
                doof.engEnd = engDfa.engEnd + nextStart
                hangerOne = engDfa.hinEnd + nextStart

                nextStart = doof.nextIndex
                doof.mergeDfa(engDfa, linguistic_theory)
                doof.mergeStates(doof.hinEnd, [nextStart], linguistic_theory)
                doof.hinEnd = engDfa.hinEnd + nextStart
                hangerTwo = engDfa.engEnd + nextStart

                doof.mergeStates(hangerOne, [hangerTwo], linguistic_theory)
                ...
                doof.mergeStates(engDfa.hinEnd + nextStart,
                                 [engDfa.mixEnd + nextStart], linguistic_theory)
                hangerOne = engDfa.hinEnd + nextStart
            ...
            if engDfa.mixEnd == -1:
                ...
                nextStart = doof.nextIndex
                doof.mergeDfa(engDfa, linguistic_theory)
                doof.mergeStates(doof.mixEnd, [nextStart], linguistic_theory)
                doof.mergeStates(engDfa.hinEnd + nextStart,
                                 [engDfa.engEnd + nextStart], linguistic_theory)

                doof.mergeStates(engDfa.hinEnd + nextStart,
                                 [hangerOne, hangerTwo], linguistic_theory)
...
def makeBlownUpEqLattice(node, grammar):
    ...
    while nextEP < len(node.children):
        ...
        if nextEP - prevEP == 1:
            ...
            engDfa.mergeDfa(hinDfa, linguistic_theory)
            engDfa.mergeStates(currStart, [nextStart], linguistic_theory)
            engDfa.hinEnd = hinDfa.hinEnd + nextStart

            if engDfa.mixEnd != -1:
                if hinDfa.mixEnd != -1:
                    engDfa.mergeStates(
                        engDfa.mixEnd, [hinDfa.mixEnd + nextStart], linguistic_theory)
            else:
                if hinDfa.mixEnd != -1:
...
def makeEqLattice(node, grammar, ln_theory):
    global linguistic_theory
    linguistic_theory = ln_theory
    ...
    if node.methodLabel == 1:
        ...
        for child in node.children:
            makeEqLattice(child, grammar, linguistic_theory)
            if child.methodLabel == 1:
                child.doof.mergeSpokes(linguistic_theory)
